...
export default function About() {
    return(
        <div className="h-screen mx:-[10%] lg:px-[15%] pt-[26%] md:pt-[10%] xl:pt-[8%] bg-cover bg-[#ffffff] bg-fixed pb-[10%]">
            <div className="text-4xl lg:text-5xl font-bold mt-7 mb-10 text-[#2f4e80]">About</div>
            <div className="h-max">
