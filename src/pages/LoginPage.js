  ...
  return (
    <div className="h-screen bg-cover bg-[#ffffff] bg-fixed pb-[10%]">
      <div className="px-[10%] mx-[2%] lg:px-[15%] pt-[26%] md:pt-[8%]">
        <div className="text-4xl lg:text-5xl font-bold my-7">Admin Dashboard</div>
    ...
    <div>
      {!authToken ? (
        ...
        <>
          {dashboardComponent}
          <button
            className="absolute top-[20.75%] md:top-[15%] 2xl:top-[15%] right-[8%] xl:right-[18.5%] p-3 bg-red-500 hover:bg-red-700 transition ease-in-out duration-500 text-white rounded-lg font-semibold"
