...
export default function Services() {
    return(
        <div className="h-min pb-[25%] lg:pb-[10%] px-[18.5%] pt-[22%] md:pt-[10%] xl:pt-[8%] bg-cover bg-[#ffffffaa] bg-fixed">
            <div className="text-6xl font-bold my-7 text-[#2f4e80]">Services</div>
            <div className="md:flex justify-start xl:p-4"> 
